...
parser.add_argument('--data', type=str, required=True,
                    default='dj_num', help='data')
parser.add_argument('--root_path', type=str,
                    default='./M_Data/ETT/', help='root path of the data file')
parser.add_argument('--data_path', type=str,
                    default='dj_num.csv', help='data file')
...
data_parser = {
    'dj_num': {'data': 'dj_num.csv', 'T': 'OT', 'M': [9, 9, 9], 'S': [1, 1, 1], 'MS': [9, 9, 1]},
